...
_$_Formats _$$_FormatsFromJson(Map<String, dynamic> json) => _$_Formats(
      thumbnail: Large.fromJson(json['thumbnail'] as Map<String, dynamic>),
      small: Large.fromJson(json['small'] as Map<String, dynamic>),
      medium: Large.fromJson(json['medium'] as Map<String, dynamic>),
